...
return array (
  ...
  'By setting an url shortcut value, you can create a better readable url for your page. If <b>URL Rewriting</b> is enabled on your site, the value \'mypage\' will result in an url \'www.example.de/p/mypage\'.' => 'Genom att ange en url som genväg kan du skapa en bättre läsbar webbadress för din sida. Om <b> Omskrivning för URL</b> är aktiverat på din webbplats kommer "min sida" att resultera i en webbadress "www.example.de/p/mypage".',
