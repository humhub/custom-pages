...
return [
    ...
    'Allows to add pages (markdown, iframe or links) to the space navigation' => 'Tillåter att lägga till sidor (markdown, iframe eller länkar) till rummets navigering',
