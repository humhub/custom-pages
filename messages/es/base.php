...
return [
    '<strong>Add</strong> {templateName} item' => '<strong> Agregar </strong> elemento de {templateName}',
    ...
    'Additional IFrame Attributes' => 'Atributos adicionales del IFRAME',
    ...
    'Empty' => 'Vacío',
    'Empty content elements cannot be deleted!' => '¡No se pueden borrar elementos de contenido vacíos!',
    'File' => 'Archivo',
    ...
    'Pages' => 'Páginas',
    'Panel' => 'Panel',
    'People Buttons' => 'Botones de personas',
    ...
    'Public' => 'Público',
    'Reset' => 'Borrar',
    'Reset the content to default value' => 'Reiniciar el contenido a su valor por defecto',
    ...
    'Space Page' => 'Página de espacio',
    'Space Widget' => 'Widget de espacio',
    'Spaces' => 'Espacios',
    'Stream' => 'Stream',
    ...
    'Will embed the result of a given url as an iframe element.' => 'Incrustará el resultado de una URL determinada como un elemento iframe.',
    ...
    'Wrap this HTML page with white panel' => 'Envolver esta página HTML con un panel blanco',
