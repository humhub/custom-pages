...
<div class="modal-footer">
    ...
    <?php if (!$model->content->isNewRecord && $resetUrl != null) : ?>
        <button class="btn btn-danger pull-left"
                style="background:transparent"><?= Yii::t('CustomPagesModule.base', 'Reset'); ?></button>
    <?php endif; ?>

    <button type="submit" data-action-click="editElementSubmit" data-action-target="#templatePageRoot" data-ui-loader
    ...
    <?php if (!$model->content->isNewRecord && $resetUrl != null) : ?>
        <button data-action-click="reset" data-action-url="<?= $resetUrl ?>" data-action-target="#templatePageRoot"
                class="btn btn-danger pull-right" data-ui-loader>
