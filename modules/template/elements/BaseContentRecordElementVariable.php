...
class BaseContentRecordElementVariable extends BaseRecordElementVariable
{
    ...
    public ?UserElementVariable $_updater = null;
    ...
    public function getUpdater(): ?UserElementVariable
    {
        if ($this->_updater === null && $this->record instanceof ContentActiveRecord) {
            $this->_updater = UserElementVariable::instance($this->elementContent)
